...
public class LinkmanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_home_linkman, container, false);
    }
    ...
    public void onStart() {
        super.onStart();
        mainlistview = (ExpandableListView) getView()
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            String key = LinkmanFragment.this.parent.get(groupPosition);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            tv.setText(LinkmanFragment.this.parent.get(groupPosition));
            return tv;
        }
