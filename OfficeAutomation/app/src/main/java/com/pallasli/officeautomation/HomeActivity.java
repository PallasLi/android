...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
     ...
     * Fragment数组界面
     */
    private Class mFragmentArray[] = {MessageFragment.class, LinkmanFragment.class, WorkbenchFragment.class,
            ZoneFragment.class};
    /**
     * 存放图片数组
     *
...
//            R.drawable.tab_square_btn, R.drawable.tab_more_btn };
     ...
     * 选修卡文字
     */
    private String mTextArray[] = {"消息", "好友", "工作台", "好友圈"};
    /**
...
//                    .setBackgroundResource(R.drawable.selector_tab_background);
    ...
    private View getTabItemView(int index) {
        View view = mLayoutInflater.inflate(R.layout.tab_home_item_view, null);
...
System.err.println(id);
        if (id == R.id.nav_bpm_start) {
            ...
            it.setClass(HomeActivity.this,MyOwnProcessListActivity.class);
            startActivity(it);
         } else if (id == R.id.nav_bpm_my_apply) {
            Intent it= new Intent();
            it.setClass(HomeActivity.this,MyApplyListActivity.class);
            startActivity(it);
         } else if (id == R.id.nav_bpm_my_todo) {
            Intent it= new Intent();
            it.setClass(HomeActivity.this,MyTodoListActivity.class);
            startActivity(it);

        } else if (id == R.id.nav_bpm_my_done) {
            Intent it= new Intent();
            it.setClass(HomeActivity.this,MyDoneListActivity.class);
            startActivity(it);

        } else if (id == R.id.nav_bpm_my_draft) {
            Intent it= new Intent();
            it.setClass(HomeActivity.this,MyDraftListActivity.class);
            startActivity(it);

        } else if (id == R.id.nav_hr_ask_for_leave) {
            Intent it= new Intent();
            it.setClass(HomeActivity.this,AskForLeaveActivity.class);
            startActivity(it);
