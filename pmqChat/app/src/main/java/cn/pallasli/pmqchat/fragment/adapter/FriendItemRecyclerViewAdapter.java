...
import cn.pallasli.pmqchat.fragment.FriendItemFragment.OnListFragmentInteractionListener;
...
public class FriendItemRecyclerViewAdapter extends RecyclerView.Adapter<FriendItemRecyclerViewAdapter.ViewHolder> {
    ...
    public FriendItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
